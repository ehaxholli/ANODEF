...
def odeint(func, y0, t, rtol=1e-7, atol=1e-9, method='dopri5', options=None):
    ...
    """
    shapes, func, y0, t, rtol, atol, method, options = _check_inputs(func, y0, t, rtol, atol, 'dopri5', options, SOLVERS)

    solver = SOLVERS['rk4'](func=func, y0=y0, rtol=rtol, atol=atol, **options)
